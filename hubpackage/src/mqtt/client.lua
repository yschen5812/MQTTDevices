...
function client_mt:disconnect(rc, properties, user_properties)
  ...
  if self.keepalive_timer then
    thisDriver:cancel_timer(self.keepalive_timer)
...
function client_mt:close_connection(reason)
  ...
  if self.keepalive_timer then
    thisDriver:cancel_timer(self.keepalive_timer) -- Cancel Keep-Alive routine timer *****
    self.keepalive_timer = nil
  end
...
function client_mt:open_connection()
  ...
  self.keepalive_timer = thisDriver:call_on_schedule(self.args.keep_alive, function()
    self:send_pingreq()
...
function client_mt:acknowledge_pubrel(packet_id)
  ...
  local pubrel = self._make_packet {
...
function client_mt:acknowledge_pubcomp(packet_id)
  ...
  local pubcomp = self._make_packet {
